...
namespace UIWidgetsSamples
{
	...
	/// </summary>
	public class GroupedListViewComponentItem : ComponentPool<GroupedListViewComponentItem>, IGroupedListViewComponent
	{
		/// <summary>
		/// Name.
		/// </summary>
		...
		public virtual void GraphicsColoring(Color foreground, Color background, float fadeDuration=0.0f)
		{
