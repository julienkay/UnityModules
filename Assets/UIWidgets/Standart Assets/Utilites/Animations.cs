...
namespace UIWidgets
{
	...
	public static class Animations
	{
		...
		static public IEnumerator Rotate(RectTransform rectTransform, float time=0.5f, float startAngle = 0, float endAngle = 90, bool unscaledTime = false)
		{
		...
		/// <param name="endAngle">End rotation angle.</param>
		/// <param name="unscaledTime">Use unscaled time.</param>
		static public IEnumerator RotateZ(RectTransform rectTransform, float time=0.5f, float startAngle = 0, float endAngle = 90, bool unscaledTime = false)
		{
			if (rectTransform!=null)
			{
				var start_rotarion = rectTransform.localRotation.eulerAngles;
		...
		/// <param name="isHorizontal">Is Horizontal animated width changes; otherwise height.</param>
		/// <param name="unscaledTime">Use unscaled time.</param>
		static public IEnumerator CollapseFlexible(RectTransform rectTransform, float time=0.5f, bool isHorizontal = false, bool unscaledTime = false)
		{
			if (rectTransform!=null)
			{
				var layoutElement = rectTransform.GetComponent<LayoutElement>();
		...
		/// <param name="isHorizontal">Is Horizontal animated width changes; otherwise height.</param>
		/// <param name="unscaledTime">Use unscaled time.</param>
		static public IEnumerator OpenFlexible(RectTransform rectTransform, float time=0.5f, bool isHorizontal = false, bool unscaledTime = false)
		{
			if (rectTransform!=null)
			{
				var layoutElement = rectTransform.GetComponent<LayoutElement>();
