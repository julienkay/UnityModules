...
namespace UIWidgets
{
	...
	public class Autocomplete : MonoBehaviour
	{
		...
		protected virtual void Start()
		{
			...
			{
				inputListener = InputFieldProxy.gameObject.AddComponent<InputFieldListener>();
			}
		...
		protected virtual void InputDeselected(BaseEventData eventData)
		{
			...
			if ((ev!=null) && (ev.pointerCurrentRaycast.gameObject!=null) && (ev.pointerCurrentRaycast.gameObject.transform.IsChildOf(DisplayListView.Container)))
			{
		...
		protected virtual void ApplyFilter(string input)
		{
			...
			DisplayListView.DataSource = result;
